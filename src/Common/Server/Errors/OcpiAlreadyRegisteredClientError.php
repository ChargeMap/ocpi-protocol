...
class OcpiAlreadyRegisteredClientError extends OcpiClientError
{
    public function __construct(string $message = "A client with these credentials is already registered.", Throwable $previous = null)
    {
